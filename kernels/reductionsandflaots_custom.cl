...
__kernel void reductionAddFloats(__global long *_kernel_context, __constant uchar *_constant_region, __local uchar *_local_region, __global int *_atomics, __global uchar *input, __global uchar *result)
{
  int i_27, i_28, i_23, i_24, i_5, i_6, i_3, i_4, i_33, i_13, i_14, i_7, i_20, i_17, i_15, i_16; 
  ulong ul_1, ul_0, ul_32, ul_11; 
  long l_30, l_31, l_10, l_29, l_8, l_9; 
  float f_21, f_22, f_26, f_12, f_19; 
  bool b_18, b_25; 
  // BLOCK 0
  ul_0  =  (ulong) input;
  ul_1  =  (ulong) result;
  ...
  for(;i_5 < 8192;)
  {
    ...
    // BLOCK 8
    barrier(CLK_LOCAL_MEM_FENCE);  // ONLY CHANGE: was CLK_GLOBAL_MEM_FENCE
    i_24  =  i_3 + i_5;
    b_25  =  i_6 == 0;
    if(b_25)
    {
...
{
  ulong ul_3, ul_5, ul_15, ul_1, ul_17, ul_0, ul_11, ul_13, ul_7, ul_9; 
  float f_4, f_6, f_8, f_10, f_2, f_20, f_21, f_22, f_23, f_24, f_25, f_26, f_12, f_14, f_16, f_18, f_19; 
  // BLOCK 0
  ul_0  =  (ulong) array;
  ul_1  =  ul_0 + 16L;
