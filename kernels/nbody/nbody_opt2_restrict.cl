...
// ============================================================================
// Optimization 2: restrict keyword ONLY
// Tells compiler that pos and vel don't alias
...
__kernel void nBody(__global long *_kernel_context, 
                    ...
                    __global uchar * restrict refPos,   // OPTIMIZATION: restrict
                    __global uchar * restrict refVel,   // OPTIMIZATION: restrict
                    ...
                    __private float espSqr)
{
    ...
    for (int i_8 = i_7; i_8 < 2048; i_8 += i_6) {
        ...
        for (int i_22 = 0; i_22 < 2048; i_22++) {
            ...
            double d_56 = (double) f_55;
            double d_57 = rsqrt(d_56);
            float f_58 = (float) d_57;
