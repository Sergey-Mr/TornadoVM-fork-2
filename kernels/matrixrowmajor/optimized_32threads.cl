...
// ============================================================================
// Optimized Matrix-Vector Row Major (32 threads per work-group)
// Compatible with existing benchmark using LOCAL_WORK_GROUP_SIZE = 32
                                  ...
                                  __private int localWorkGroupSize)
{
    ...
    // Each thread processes 4 floats per iteration at stride = WG_SIZE*4 = 128
    // ========================================================================
    const int vecStride = WG_SIZE * 4;       // 128 elements per stride
    ...
    // Total elements per iteration: 4 * 128 = 512 elements
    // Iterations needed: 8192 / 512 = 16 iterations
    ...
    // ========================================================================
    // Parallel reduction in local memory - fully unrolled for 32 threads
    // ========================================================================
    scratch[lid] = partial;
    barrier(CLK_LOCAL_MEM_FENCE);

    // Unrolled reduction tree for WG_SIZE=32
