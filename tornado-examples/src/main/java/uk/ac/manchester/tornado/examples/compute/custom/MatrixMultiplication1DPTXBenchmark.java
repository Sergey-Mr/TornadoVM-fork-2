...
/**
 * PTX Single-kernel benchmark for Matrix Multiplication 1D (flat arrays).
 * Measures ONLY kernel execution time - run once per kernel for fair comparison.
 *
 * Usage: java ... MatrixMultiplication1DPTXBenchmark <kernel.ptx> [size]
 *
...
public class MatrixMultiplication1DPTXBenchmark {
    ...
    public static void main(String[] args) throws TornadoExecutionPlanException {
        if (args.length < 1) {
            System.out.println("Usage: MatrixMultiplication1DPTXBenchmark <kernel.ptx> [size]");
        ...
        System.out.println("=== Matrix Multiplication 1D PTX Benchmark ===");
        System.out.println("Kernel: " + kernelPath);
        System.out.println("Matrix size: " + size + "x" + size);
        System.out.println("Local work size: " + LOCAL_WORK_SIZE_X + "x" + LOCAL_WORK_SIZE_Y);
