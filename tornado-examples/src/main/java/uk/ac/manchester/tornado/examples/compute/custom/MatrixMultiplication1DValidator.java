...
/**
 * Validates Matrix Multiplication 1D kernel output against sequential baseline.
 * Separate from benchmark to avoid affecting GPU warmup state.
 *
 * Usage: java ... MatrixMultiplication1DValidator <kernel1.cl> [kernel2.cl] ... [--size=N]
 */
public class MatrixMultiplication1DValidator {
    ...
    public static void main(String[] args) throws TornadoExecutionPlanException {
        if (args.length < 1) {
            System.out.println("Usage: MatrixMultiplication1DValidator <kernel1.cl> [kernel2.cl] ... [--size=N]");
            System.exit(1);
        }
