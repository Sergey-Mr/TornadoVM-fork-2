...
/**
 * Validates Monte Carlo kernel output against sequential baseline.
 * Separate from benchmark to avoid affecting GPU warmup state.
 *
 * Usage: java ... MonteCarloValidator <kernel1.cl> [kernel2.cl] ... [--samples=N]
 */
public class MonteCarloValidator {
    ...
    public static void main(String[] args) throws TornadoExecutionPlanException {
        if (args.length < 1) {
            System.out.println("Usage: MonteCarloValidator <kernel1.cl> [kernel2.cl] ... [--samples=N]");
            System.exit(1);
        }
