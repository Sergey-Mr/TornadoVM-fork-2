...
/**
 * PTX Single-kernel benchmark for BFS (Breadth-First Search).
 ...
 *
 * Usage: java ... BFSPTXBenchmark <kernel.ptx> [numNodes]
 *
...
public class BFSPTXBenchmark {
    ...
    public static void main(String[] args) throws TornadoExecutionPlanException {
        if (args.length < 1) {
            System.out.println("Usage: BFSPTXBenchmark <kernel.ptx> [numNodes]");
        ...
        System.out.println("=== BFS PTX Benchmark ===");
        ...
        // Edge traversals: approximate TEPS
        long totalEdgeTraversals = (long) numNodes * numNodes;
        double mteps = (totalEdgeTraversals * 1e-6) / (stats.getAverage() * 1e-9);
