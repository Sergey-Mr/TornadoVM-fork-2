...
/**
 * PTX Single-kernel benchmark for NBody simulation.
 * Measures ONLY kernel execution time - run once per kernel for fair comparison.
 *
 * Usage: java ... NBodyPTXBenchmark <kernel.ptx> [numBodies]
 *
...
public class NBodyPTXBenchmark {
    ...
    public static void main(String[] args) throws TornadoExecutionPlanException {
        if (args.length < 1) {
            System.out.println("Usage: NBodyPTXBenchmark <kernel.ptx> [numBodies]");
        ...
        System.out.println("=== NBody PTX Benchmark ===");
